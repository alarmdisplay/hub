    ...
    <div class="card-content">
      <article class="media">
          ...
          <div class="content">
            ...
            <div class="level">
              <div class="level-left">
                <div
                  class="level-item"
                  title="Anzahl hinterlegter Schleifen"
                >
                ...
                <div
                  class="level-item"
                  title="Anzahl hinterlegter alternativer Bezeichnungen"
                >
        ...
        <div class="media-right">
          <router-link
            class="button"
            :to="{ name: 'resource-form', params: { id: resource.id } }"
            title="Einsatzmittel bearbeiten"
          >
            <span class="icon">
